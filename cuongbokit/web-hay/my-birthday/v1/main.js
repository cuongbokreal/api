...
(function () {
  ...
  var getName = getUrlParameter('name').replaceAll('+',' ').replaceAll('%20', ' ');
  var regDay = getDay.match(/[0-9]{2}/g);
  
  document.getElementById('name').innerText = `${decodeURIComponent(getName).replaceAll('+',' ')}`; //${getName.replaceAll(/\+|%20/g,' ')}
