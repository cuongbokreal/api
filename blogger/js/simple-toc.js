// ---------------------------------------------------
// Author: Cuong
// Url: https://cuongbokit.blogspot.com/
// Version: 2
// Date: 09/11/2021
// ---------------------------------------------------
...
// this function creates a three-column table and adds it to the screen
   ...
   tocTable += '<a href="javascript:toggleDateSort();" title="' + tocTool2 + '" alt="' + tocTool2 + '">' + tocHead2 + '</a>';
   tocTable += '</td>';
   tocTable += '<td class="toc-header-col3">';
   tocTable += '<a href="javascript:allPosts();" title="' + tocTool3 + '" alt="' + tocTool2 + '">' + tocHead3 + '</a>';
   tocTable += '</td>';
   tocTable += '</tr>';
   for (var i = 0; i < postTitle.length; i++) {
      if (filter == '') {
         tocTable += '<tr><td class="toc-entry-col1"><a href="' + postUrl[i] + '" alt="' + postSum[i] + '" title="' + postSum[i] + '">' + postTitle[i] + '</a></td><td class="toc-entry-col2">' + postDate[i] + '</td><td class="toc-entry-col3">' + postLabels[i] + '</td></tr>';
         numDisplayed++;
      } else {
